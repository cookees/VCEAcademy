    ...
    return (
      ...
      <Card className={classes.paper}>
          ...
          <MenuList>
            ...
            <MenuItem onClick={() => {this.props.change(10)}}>
              <Typography variant ='body2' style = {{paddingLeft: 8}} align = 'left'>
      ...
      >
        ...
        <ListItem onClick={this.handleClickOpenVideo} button>
          ...
          <ListItemText primary="Fraction Power Functions" />
        </ListItem>
        ...
        >
          ...
          <DialogContent>
            ...
            <img
            src="https://i.imgur.com/HVCpSWt.png?1"
            alt="new"
            /><br/><br/>

            <img
            src="https://i.imgur.com/nx7mt4B.png?1"
            alt="new"
            /><br/><br/>

            <img
            src="https://i.imgur.com/4bvvHMT.png?1"
            alt="new"
            /><br/><br/>

            <img
            src="https://i.imgur.com/2DqPRIj.png?1"
            alt="new"
            /><br/><br/>

            <img
            src="https://i.imgur.com/QM95O5m.png?1"
            alt="new"
            /><br/><br/>

            <img
            src="https://i.imgur.com/cgVJrXf.png?1"
            alt="new"
            /><br/><br/>

            <img
            src="https://i.imgur.com/cmX7W1B.png?1"
            alt="new"
            /><br/><br/>

            <img
            src="http://wiki.engageeducation.org.au/wp-content/uploads/2015/10/funcinteger4-300x300.jpg"
            alt="new"
            /><br/><br/>
