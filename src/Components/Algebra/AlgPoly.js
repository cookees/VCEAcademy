...
export default class AlgPoly extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      video: 'hPZuavez2y8',
      item: [{link: 'https://i.imgur.com/I1Ft7Dy.png?1'},{link: 'https://i.imgur.com/AM8Rbjb.png?1'},{link: 'https://i.imgur.com/MyuY2Ef.png?1'},
      {link: 'https://i.imgur.com/PjpRAWi.png?1'}, {link: 'https://i.imgur.com/DI1RL7e.png?1'}  ]
    };
