...
export default class Inverse extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      video: 'bceRhDBJygU',
      item: [{link: 'https://i.imgur.com/UjF5H00.png?1'},{link: 'https://i.imgur.com/GKPe9jV.png?1'},{link: 'https://i.imgur.com/36g1WEo.png?1'},
      {link: 'https://i.imgur.com/eC98ucE.png?1'},  ]
    };
