...
export default class Trigon extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      video: '3YeXHnsz2rw',
      item: [{link: 'https://i.imgur.com/xwPSM8B.png?1'},{link: 'https://i.imgur.com/x0TwaiM.png?1'},{link: 'https://i.imgur.com/fyoz843.png?1'},
      ]
    };
