...
export default class LogExLaws extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      name: 'Logarithmic and Exponential Laws',
      video: 'U0mMVRlsocU',
      item: [{link: 'https://i.imgur.com/WLhdLay.png?1'},{link: 'https://i.imgur.com/XrIERZq.png?1'},{link: 'https://i.imgur.com/XzcsMMW.png?1'} ]
    };
