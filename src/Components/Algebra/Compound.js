...
export default class Compound extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      name: 'Compound and Double Angle Formula',
      video: 'e6d02oTovUA',
      item: [{link: 'https://i.imgur.com/49dVvKK.png?1'},{link: 'https://i.imgur.com/KohfPe4.png?1'},{link: 'https://i.imgur.com/7T3wAfb.png?1'},
      {link: 'https://i.imgur.com/rhN0eFB.png?1'},{link: 'https://i.imgur.com/4gDapay.png?1'} ]
    };
