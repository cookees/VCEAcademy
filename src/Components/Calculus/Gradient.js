...
export default class Gradient extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      video: 'tgnWOcrkxe8',
      item: [{link: 'https://i.imgur.com/G0xdY5N.png?1'},{link: 'https://i.imgur.com/jqIj9qD.png?1'},{link: 'https://i.imgur.com/t0qsRNL.png?1'},
      {link: 'https://i.imgur.com/WrqZB1W.png?1'}, {link: 'https://i.imgur.com/6qQaBTc.png?1'} ]
    };
