...
export default class Rate extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      name: 'Rate of Change',
      video: 'iMOQlTYpYX0',
      item: [{link: 'https://i.imgur.com/JuL8nkl.png?1'},{link: 'https://i.imgur.com/Rp8ypUm.png?1'},{link: 'https://i.imgur.com/NO4HMOk.png?1'},
      {link: 'https://i.imgur.com/sOAgIv1.png?1'} ]
    };
