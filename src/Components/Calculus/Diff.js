...
export default class Diff extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      name: 'Differentiation of Power Functions / Exponentials',
      video: 'mI-jt6y18Qk',
      item: [{link: 'https://i.imgur.com/ThaaK2Q.png?1'},{link: 'https://i.imgur.com/ObWGC0B.png?1'},{link: 'https://i.imgur.com/NOPpZNq.png?1'},
      {link: 'https://i.imgur.com/KgODiqg.png?1'} ]
    };
