...
export default class IntPow extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      name: 'Integration of Power and Logarithmic Functions',
      video: '9jixY3A3RsM',
      item: [{link: 'https://i.imgur.com/Q2QVckC.png?1'},{link: 'https://i.imgur.com/ZxChY8v.png?1'},{link: 'https://i.imgur.com/Xq6rafW.png?1'},]
    };
