...
export default class Transitions extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      video: '3YeXHnsz2rw',
      item: [{link: 'https://i.imgur.com/yWeEAtw.png?1'}, {link: 'https://i.imgur.com/i4nPA5b.png?1'}, {link: 'https://i.imgur.com/cQ0ZOwN.png?1'},
      {link: 'https://i.imgur.com/Gr1B3GH.png?1'},
    ]
    };
