...
import MoreMatrices from './MoreMatrices';
...
export default class Linear extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      video: '3YeXHnsz2rw',
      item: [{link: 'https://i.imgur.com/4KD7Ap7.png?1'}, {link: 'https://i.imgur.com/NW7Wdgo.png?1'}, {link: 'https://i.imgur.com/dlhSQyK.png?1'},
      {link: 'https://i.imgur.com/0OykrTI.png?1'},
    ]
    };
