...
export default class Samples extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      video: '3YeXHnsz2rw',
      item: [{link: 'https://i.imgur.com/hgI3iwW.png?1'}, {link: 'https://i.imgur.com/WbTCIyD.png?1'}, {link: 'https://i.imgur.com/CU7ucwf.png?1'},
      {link: 'https://i.imgur.com/CU7ucwf.png?1'},{link: 'https://i.imgur.com/Xof9cXm.png?1'},{link: 'https://i.imgur.com/RUvnphf.png?1'},]
    };
