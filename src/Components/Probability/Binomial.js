...
export default class Binomial extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      video: 'rIJqOsrOvEU',
      item: [{link: 'https://i.imgur.com/gTsvm6H.png?1'},{link: 'https://i.imgur.com/Dhoei6N.png?1'},{link: 'https://i.imgur.com/7onlinV.png?1'},
        ]
    };
