...
export default class Normal extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      video: 'BByChjOwh6Q',
      item: [{link: 'https://i.imgur.com/R0sgskC.png?1'},{link: 'https://i.imgur.com/GtjB0nh.png?1'},{link: 'https://i.imgur.com/ubVCXBO.png?1'},
      {link: 'https://i.imgur.com/sdqWeZY.png?1'}, {link: 'https://i.imgur.com/ngpRQKW.png?1'}  ]
    };
